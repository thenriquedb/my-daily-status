...
function status(_ref) {
  ...
  function selectSymptom(symptom) {
    ...
    setSelectedSymptoms([].concat(Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__["default"])(selectedSymptoms), [key]));
  }
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function handleSave$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            alert('ok'); // const response = await axios.post('/api/status/store', {
            //   status,
            //   coords,
            // });
  ...
  if (isAuth) {
    ...
    }, user.name), ", como voc\xEA est\xE1 se sentindo hoje? Selecione a baixo os sintomas que voc\xEA esta sentindo. Caso n\xE3o esteja apresentando nenhum, clique em continuar.", ' ')), __jsx("div", {
...
//# sourceMappingURL=status.js.1e7b129524eea7387e24.hot-update.js.map