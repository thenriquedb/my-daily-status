...
function status(_ref) {
  ...
  var _useState2 = Object(react__WEBPACK_IMPORTED_MODULE_2__["useState"])([]),
      ...
      setSelectedSymptoms = _useState2[1]; // function getUserLocation() {
  //   if (navigator.geolocation) {
  //     navigator.geolocation.getCurrentPosition((position) => {
  //       const { latitude, longistatustude } = position.coords;
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(axios__WEBPACK_IMPORTED_MODULE_4___default.a.post('/api/status/store', {
              symptoms: selectedSymptoms // coords,
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(function () {
    if (!isAuth) next_router__WEBPACK_IMPORTED_MODULE_3___default.a.push('/'); // getUserLocation();
  }, [isAuth]);
...
//# sourceMappingURL=status.js.e257ea4ecdf3fc7ac9a7.hot-update.js.map