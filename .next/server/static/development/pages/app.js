...
/* harmony import */ var _util_getCurrentDate__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../util/getCurrentDate */ "./util/getCurrentDate.js");
/* harmony import */ var _lib_firebase__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../lib/firebase */ "./lib/firebase.js");
/* harmony import */ var _lib_firebase__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_lib_firebase__WEBPACK_IMPORTED_MODULE_6__);
...
async function getServerSideProps({
  ...
  const session = await _lib_auth0__WEBPACK_IMPORTED_MODULE_4__["default"].getSession(req); // Verifica se o usuário está logado
  ...
  const currentDate = Object(_util_getCurrentDate__WEBPACK_IMPORTED_MODULE_5__["default"])();
  const userDailyStatus = await _lib_firebase__WEBPACK_IMPORTED_MODULE_6__["db"].collection('markers').doc(currentDate).collection('checks').doc(session.user.sub).get();
  ...
  const nearbyUsers = await _lib_firebase__WEBPACK_IMPORTED_MODULE_6__["db"].collection('markers').doc(currentDate).collection('checks').near({
    center: coordinates,
    radius: 1000
  }).get();
