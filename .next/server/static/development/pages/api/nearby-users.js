...
/* harmony import */ var _util_getCurrentDate__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../util/getCurrentDate */ "./util/getCurrentDate.js");
...
/* harmony default export */ __webpack_exports__["default"] = (async function (req, res) {
  ...
  let nearbyUsers;
  const currentDate = Object(_util_getCurrentDate__WEBPACK_IMPORTED_MODULE_1__["default"])();
  console.log(latitude, currentDate, longitude, filter, radius);

  switch (filter.toLowerCase()) {
    case 'covid':
    case 'suspect':
      nearbyUsers = await _lib_firebase__WEBPACK_IMPORTED_MODULE_0__["db"].collection('history').doc(currentDate).collection('all').where('status', '==', filter).near({
        center: {
    ...
    default:
      nearbyUsers = await _lib_firebase__WEBPACK_IMPORTED_MODULE_0__["db"].collection('history').doc(currentDate).collection('all').near({
        center: {
          latitude: parseFloat(latitude),
          longitude: parseFloat(longitude)
        },
...
/***/ 10:
/*!*****************************************!*\
  !*** multi ./pages/api/nearby-users.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /home/thiago/Documentos/Dev/Projetos/fullstack-lab/pages/api/nearby-users.js */"./pages/api/nearby-users.js");
...
/******/ });
//# sourceMappingURL=nearby-users.js.map